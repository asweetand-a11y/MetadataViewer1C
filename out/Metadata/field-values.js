 ...
 */
function isTextInputField(fieldName) {
    const cleanName = fieldName.replace(/^(xr:|v8:|cfg:|app:)/, '');
    return exports.TEXT_INPUT_FIELDS.includes(cleanName);
}
...
function getFieldLabel(field) {
    ...
    return exports.FIELD_LABELS[cleanName] || field;
}
