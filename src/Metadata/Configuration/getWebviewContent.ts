...
import { getCodiconStylesheetUri, getConfigWebviewScriptUri } from "../../utils/webviewAssets";

export function getWebviewContent(webview: Webview, extensionUri: Uri, configuration: Configuration) {
  const elementsUri = getConfigWebviewScriptUri(webview, extensionUri);
      ...
      <body id="webview-body">
        ...
        <section class="column-container">
          ...
          <div class="parameter-container">
            ...
            <vscode-text-field id="name" value="${configuration.name}" placeholder="Enter a name" readonly></vscode-text-field>
          </div>
          <div class="parameter-container">
            ...
            <vscode-text-field id="synonym" value="${configuration.synonym}" placeholder="Enter a synonym" readonly></vscode-text-field>
          </div>
          <div class="parameter-container">
            ...
            <vscode-text-field id="comment" value="${configuration.comment}" placeholder="Enter a comment" readonly></vscode-text-field>
          </div>
          <div class="parameter-container">
          ...
          <div class="parameter-container">
            ...
            <div>
              <vscode-button id="add-purpose-button" appearance="primary" class="parameter-button" disabled>Добавить назначение</vscode-button>
            </div>
          </div>
          <div class="parameter-container">
          ...
          <div class="parameter-container">
            ...
            <div>
              <vscode-button id="add-role-button" appearance="primary" class="parameter-button" disabled>Добавить роль</vscode-button>
            </div>
          </div>
          <div class="parameter-container">
          ...
          <div class="parameter-container">
            ...
            <vscode-text-field id="briefInformation" value="${configuration.briefInformation}" placeholder="" readonly></vscode-text-field>
          </div>
          <div class="parameter-container">
            ...
            <vscode-text-area id="detailedInformation" value="${configuration.detailedInformation}" placeholder="" readonly></vscode-text-area>
          </div>
          <div class="parameter-container">
            <p class="label">Авторские права</p>
            <p class="description">Информация об авторе конфигурации.</p>
            <vscode-text-field id="copyright" value="${configuration.copyright}" placeholder="" readonly></vscode-text-field>
          </div>
          <div class="parameter-container">
            ...
            <vscode-text-field id="vendorInformationAddress" value="${configuration.vendorInformationAddress}" placeholder="" readonly></vscode-text-field>
          </div>
          <div class="parameter-container">
            ...
            <vscode-text-field id="configurationInformationAddress" value="${configuration.configurationInformationAddress}" placeholder="" readonly></vscode-text-field>
          </div>
          <div class="header">Разработка</div>
          <div class="parameter-container">
            <p class="label">Поставщик</p>
            <p class="description"></p>
            <vscode-text-field id="vendor" value="${configuration.vendor}" placeholder="Enter a vendor" readonly></vscode-text-field>
          </div>
          <div class="parameter-container">
            <p class="label">Версия</p>
            <p class="description"></p>
            <vscode-text-field id="version" value="${configuration.version}" placeholder="Enter a version" readonly></vscode-text-field>
          </div>
          <div class="parameter-container">
            ...
            <vscode-text-field id="version" value="${configuration.updateCatalogAddress}" placeholder="Enter an update catalog address" readonly></vscode-text-field>
          </div>
          ...
          <div class="parameter-container">
            ...
            <vscode-single-select position="below" readonly>
              ...
              <vscode-option${(() => { return configuration.compatibilityMode === 'Version8_3_18' ? ' selected' : '' })()}>Версия 8.3.18</vscode-option>
              <vscode-option${(() => { return configuration.compatibilityMode === 'Version8_3_17' ? ' selected' : '' })()}>Версия 8.3.17</vscode-option>
              <vscode-option${(() => { return configuration.compatibilityMode === 'Version8_3_16' ? ' selected' : '' })()}>Версия 8.3.16</vscode-option>
              <vscode-option${(() => { return configuration.compatibilityMode === 'Version8_3_15' ? ' selected' : '' })()}>Версия 8.3.15</vscode-option>
              <vscode-option${(() => { return configuration.compatibilityMode === 'Version8_3_14' ? ' selected' : '' })()}>Версия 8.3.14</vscode-option>
              <vscode-option${(() => { return configuration.compatibilityMode === 'Version8_3_13' ? ' selected' : '' })()}>Версия 8.3.13</vscode-option>
              <vscode-option${(() => { return configuration.compatibilityMode === 'Version8_3_12' ? ' selected' : '' })()}>Версия 8.3.12</vscode-option>
              <vscode-option${(() => { return configuration.compatibilityMode === 'Version8_3_11' ? ' selected' : '' })()}>Версия 8.3.11</vscode-option>
              <vscode-option${(() => { return configuration.compatibilityMode === 'Version8_3_10' ? ' selected' : '' })()}>Версия 8.3.10</vscode-option>
              <vscode-option${(() => { return configuration.compatibilityMode === 'Version8_3_9' ? ' selected' : '' })()}>Версия 8.3.9</vscode-option>
              <vscode-option${(() => { return configuration.compatibilityMode === 'Version8_3_8' ? ' selected' : '' })()}>Версия 8.3.8</vscode-option>
              <vscode-option${(() => { return configuration.compatibilityMode === 'Version8_3_7' ? ' selected' : '' })()}>Версия 8.3.7</vscode-option>
              <vscode-option${(() => { return configuration.compatibilityMode === 'Version8_3_6' ? ' selected' : '' })()}>Версия 8.3.6</vscode-option>
              <vscode-option${(() => { return configuration.compatibilityMode === 'Version8_3_5' ? ' selected' : '' })()}>Версия 8.3.5</vscode-option>
              <vscode-option${(() => { return configuration.compatibilityMode === 'Version8_3_4' ? ' selected' : '' })()}>Версия 8.3.4</vscode-option>
              <vscode-option${(() => { return configuration.compatibilityMode === 'Version8_3_3' ? ' selected' : '' })()}>Версия 8.3.3</vscode-option>
              <vscode-option${(() => { return configuration.compatibilityMode === 'Version8_3_2' ? ' selected' : '' })()}>Версия 8.3.2</vscode-option>
              <vscode-option${(() => { return configuration.compatibilityMode === 'Version8_3_1' ? ' selected' : '' })()}>Версия 8.3.1</vscode-option>
